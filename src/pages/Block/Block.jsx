...
// Відгуки тепер підключаються з окремого файлу
...
export function Block() {
  ...
  useEffect(() => {
    ...
    }, 5000); // збільшено інтервал, бо відгуків тепер більше
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mt-8">
                  ...
                  <Link
                    to="/reviews"
                    className="text-[11px] font-bold uppercase tracking-widest text-orange-600 hover:text-orange-700 transition-colors whitespace-nowrap ml-4"
                  >
                    Всі відгуки →
                  </Link>
                </div>
